...
class pascalVOCLoader(data.Dataset):
    ...
    def decode_segmap(self, label_mask, plot=False):
        ...
        Args:
            label_mask (np.ndarray): an (M,N) array of integer values denoting the class label at each spatial location.
            plot (bool, optional): whether to show the resulting color image in a figure.
